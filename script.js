...
produtos.forEach((p, index) => {
  ...
  card.innerHTML = `
   <img src="${p.imagens[0]}" class="w-full h-48 object-cover rounded-xl mb-4" />
  ...
  <p class="text-pink-600 font-bold mb-4">${p.preco}</p>
    <div class="flex flex-col sm:flex-row gap-2">
      ...
      <a href="https://api.whatsapp.com/send/?phone=5585986500500&text=Ol%C3%A1%2C%20estava%20dando%20uma%20olhada%20no%20site%20e%20queria%20saber%20mais%20informa%C3%A7%C3%B5es.&type=phone_number&app_absent=0" target="_blank"
